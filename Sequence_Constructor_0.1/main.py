...
class Main_Window(QWidget):
    ...
    def initWordConstructor(self, main_layout):
        ...
        for item in self.artboard.items():
            if isinstance(item, Arrow):
                ...
                if color == 'blue':
                    ...
                    blue_text += f"Start: {attributes.get('start_position', 'N/A').capitalize()}<br>"
                    blue_text += f"End: {attributes.get('end_position', 'N/A').capitalize()}<br>"
                    blue_text += "<br>"
                elif color == 'red':
                    ...
                    red_text += f"Start: {attributes.get('start_position', 'N/A').capitalize()}<br>"
                    red_text += f"End: {attributes.get('end_position', 'N/A').capitalize()}<br>"
                    red_text += "<br>"
...
class Letter:
    ...
    def get_start_position(self):
        ...
        print("start positions: ", start_position1, start_position2)
    ...
    def get_end_position(self):
        ...
        print("end positions: ", end_position1, end_position2)
