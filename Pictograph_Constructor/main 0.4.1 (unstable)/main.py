...
class Main_Window(QWidget):
    ...
    def initUI(self):
        ...
        self.setGeometry(300, 300, 1400, 1400)  
...
class InfoTracker:
    ...
    def update(self):
        ...
        self.label.setText("<br>" + blue_text + red_text)
        ...
        for item in self.artboard.items():
            if isinstance(item, Arrow):
                ...
                if color == 'blue':
                    ...
                    red_text += "<br>"
        self.label.setText("<table><tr><td>" + "<br>" + "</td></tr><tr><td width=250>" + blue_text + "</td><td>" + red_text + "</td></tr></table>")
