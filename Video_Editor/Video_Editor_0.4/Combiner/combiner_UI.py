...
class CombinerTab(QWidget):
    ...
    def setup_ui(self):
        ...
        self.main_layout.addLayout(merge_layout)  # Add the merge layout to the main layout
        # Create the checkbox
    ...
    def convert(self):
        ...
        if image_path is None or video_path is None:
            QtWidgets.QMessageBox.warning(self, "Error", "Please select both an image and a video before merging.")
            return
    ...
    def dragEnterEvent(self, event):
        ...
        if event.mimeData().hasUrls() and len(event.mimeData().urls()) == 1:
            ...
            if url.isLocalFile():
                ...
                if (self.file_type == "image" and type_main == "image") or (self.file_type == "video" and type_main == "video"):
    ...
    def dropEvent(self, event):
        if event.mimeData().hasUrls():
            ...
            if (self.file_type == "image" and type_main != "image") or (self.file_type == "video" and type_main != "video"):
                ...
                QMessageBox.critical(self, "Error", f"Invalid file type. Expected a {self.file_type}, but received a {type_main}.")
