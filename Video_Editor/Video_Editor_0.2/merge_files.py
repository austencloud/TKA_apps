...
def combine_image_and_video(image_path, video_path, output_path, preserve_aspect_ratio=True, progress_callback=None, stop_flag_callback=None):
    try:
        # Load the image
        ...
        print("Error in combine_image_and_video:", str(e))
...
class MergeFiles(QThread):
    ...
    def run(self):
        try:
            combine_image_and_video(self.image_path, self.video_path, self.output_path, 
